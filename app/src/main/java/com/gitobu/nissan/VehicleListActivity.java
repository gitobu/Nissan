...
public class VehicleListActivity extends AppCompatActivity {
    ...
    private View.OnClickListener onItemClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            int vehicleId = vehicles.get(position).getVehicleID();
            Intent intent = new Intent(VehicleListActivity.this, VehicleActivity.class);
            intent.putExtra("vehicleKey", vehicleId);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // ArrayList<Vehicle> makes;
        ...
        try {
            ...
            vehicles = vehicleDataSource.getVehicles();
    ...
    private void initAddVehicleButton() {
        Button newVehicle = findViewById(R.id.buttonAddVehicle);
    ...
    private void initDeleteSwitch(){
        ...
        s.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                vehicleAdapter.setDelete(status);
    ...
    private void initLocationButton() {
        ...
        buttonVaccineList.setOnClickListener(v -> {
            Intent intent = new Intent(VehicleListActivity.this, LocationListActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
        });
    }
    private void initStaffButton() {
        ...
        buttonVaccineList.setOnClickListener(v -> {
            Intent intent = new Intent(VehicleListActivity.this, LocationMapActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
        });
    }
